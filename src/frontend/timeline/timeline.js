            ...
            <div className="timeLine" id = 'timeline'>
                ...
                <VerticalTimeline>
                    ...
                    <VerticalTimelineElement
                        ...
                        <Link to="/monday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        ...
                        <Link to="/tuesday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        ...
                        <Link to="/wednesday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    ...
                    <VerticalTimelineElement
                        ...
                        <Link to="/thursday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        ...
                        <h6>Margaret Hamilton : Mathematician and pioneering computer scientist
                         ...
                         <Link to="/friday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    ...
                    <VerticalTimelineElement
                        ...
                        <Link to="/saturday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        ...
                        <Link to="/sunday" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        ...
                        <Link to="/eighth" className='btn' component={Details}>
                            Find Out More...
                        </Link>
                    </VerticalTimelineElement>
                </VerticalTimeline>
